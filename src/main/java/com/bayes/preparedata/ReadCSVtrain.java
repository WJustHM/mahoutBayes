...
public class ReadCSVtrain {
    ...
    public static void main(String[] args) throws Exception {
        //train
        for (; data <= 3; data++) {
            gen = System.getProperty("user.dir") + "/Trainingdataclean/train" + data;
            run();
        }
    ...
    public static void run() {
        ...
        String file = System.getProperty("user.dir") + "/traindata/建模数据0" + data + ".xlsx";
        ReadCSVtrain read = new ReadCSVtrain();
